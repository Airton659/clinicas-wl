...
╚════════════════════════════════════════════════════════════════╝
    ...
    if len(sys.argv) < 2:
        print("❌ Uso incorreto!")
        print("\nUso correto:")
        print("  python seed_permissions.py <nome-cliente> [--confirm]")
        print("\nExemplo:")
        print("  python seed_permissions.py clinica-medica")
        print("  python seed_permissions.py clinica-medica --confirm  # Não pede confirmação")
    ...
    # Confirmar antes de executar (a menos que --confirm foi passado)
    if not auto_confirm:
        ...
        print(f"\n✅ Modo auto-confirm ativado. Executando seed para: {client_name}")
